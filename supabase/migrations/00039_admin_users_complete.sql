-- Consolidated, idempotent admin users schema for production.
-- Safe to run in Supabase SQL Editor when 00035–00038 were never applied.
--
-- Server API routes use SUPABASE_SERVICE_ROLE_KEY (bypasses RLS).
-- anon/authenticated grants exist for local dev only; production admin APIs
