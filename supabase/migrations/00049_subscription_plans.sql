-- Subscription plans — central commercial model (prices, limits, capabilities)
...
-- Seed commercial plans (idempotent)
...
-- Migrate legacy provider subscription plan ids
...
-- Universal 2.5% booking fee in platform_settings singleton
